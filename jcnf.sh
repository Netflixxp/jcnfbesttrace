...
install(){
	[[ ! -d /home/testrace/besttrace ]] && wget --no-check-certificate 'https://docs.google.com/uc?export=download&id=1XVxYdpEbnHdo1Y6CnHfXdP4n7nxiK6G' -O BestTrace.zip && unzip -zxf BestTrace.zip && rm BestTrace.zip
