...
install(){
	[[ ! -d /home/testrace/besttrace ]] && wget --no-check-certificate https://github.com/Netflixxp/jcnfbesttrace/releases/download/v0303/BestTrace.zip && unzip -zxf BestTrace.zip && rm BestTrace.zip
