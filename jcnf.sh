...
install(){
	[[ ! -d /home/testrace/besttrace ]] && wget https://github.com/Netflixxp/jcnfbesttrace/releases/download/v0303/BestTrace.tar.gz && tar -zxf BestTrace.tar.gz && rm BestTrace.tar.gz
